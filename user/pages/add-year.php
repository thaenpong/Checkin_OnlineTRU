...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title">เพิ่มข้อมูลปีการศึกษา</h2>
                    <form id="addYearForm">
                        <div class="my-4">
                            <div class="form-group mb-2">
                                <label for="name">ชื่อปีการศึกษา</label>
                                <input type="text" class="form-control" id="name" name="name">
                            </div>
                        </div>
                        <div class="d-flex justify-content-between my-4">
                            <button type="button" class="btn btn-primary" id="saveButton">บันทึก</button>
                            <a class="btn btn-danger deleteButton" href="./main.php?page=list-years">ยกเลิก</a>
                        </div>
                    </form>
                </div>
            </div>
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        Swal.fire(
                            ...
                            window.location.replace('/Checkin_OnlineTRU/user/main.php?page=list-years');
                        });
                    } else {
                        Swal.fire(
                            'เกิดข้อผิดพลาด!',
